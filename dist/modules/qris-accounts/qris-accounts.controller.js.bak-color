...
async function showAccountList(req, res) {
    try {
        ...
        // Bukan total generate. Auto-reset tiap ganti hari lewat filter paidAt >= awal hari WIB.
        ...
        const accountsWithSite = (0, site_service_1.attachSiteInfo)(accounts).map((a) => (Object.assign(Object.assign({}, a), { usedToday: paidTodayMap[a.id] || 0, healthStatus: computeLiveHealth(a) })));
